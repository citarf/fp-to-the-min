 ...
 */
case class LiveStatsAggregator(clock: Clock.Service, covid19: Covid19) extends StatsAggregator {
...
object StatsAggregator {
  val live =
    ZLayer.fromServices[Clock.Service, Covid19, StatsAggregator](LiveStatsAggregator.apply)
}
