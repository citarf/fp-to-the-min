...
object StatsInterpreter {
   ...
   */
  val live = ZLayer.fromServices[Clock.Service, Console.Service, StatsAggregator, StatsInterpreter] {
    (clock: Clock.Service, console: Console.Service, aggregator: StatsAggregator) =>
      new StatsInterpreter {
        import console._
